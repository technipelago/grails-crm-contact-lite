    ...
    <g:if test="${crmContact.company}">
        <li>
            <a href="#children" data-toggle="tab">
                <g:message code="crmContact.tab.children.label"/>
                <crm:countIndicator count="${crmContact.children.size()}"/>
            </a>
        </li>
    </g:if>
    ...
    <crm:button type="link" group="true" action="edit" id="${crmContact?.id}" visual="warning"
        ...
        <ul class="dropdown-menu">
            ...
            <g:unless test="${crmContact.company}">
                <li>
                    <a href="${createLink(controller: 'crmContact', action: 'changeParent', id: crmContact.id)}" data-toggle="modal"
...
<g:if test="${crmContact.company}">
    <div class="tab-pane" id="children">
        <g:render template="children" model="${[result: crmContact.children]}"/>

        <g:form>
            <g:hiddenField name="id" value="${crmContact?.id}"/>
            <div class="form-actions btn-toolbar">
                <div class="btn-group">
                    <crm:button type="link" action="contact"
                                params="${['parent.id': crmContact.id, referer: g.createLink(action: "show", id: crmContact.id, fragment: "children")]}"
                                icon="icon-plus icon-white"
                                visual="success"
                                label="crmContact.button.create.contact.label"
                                permission="crmContact:create"/>
                </div>
            </div>
        </g:form>
    </div>
